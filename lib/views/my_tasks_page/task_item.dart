  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
        ...
        child: GestureDetector(
            onTap: () => dispatch(SwitchMyTaskTab(myTaskTab: 1)),
            child: Container(
              decoration: const BoxDecoration(
                  border: Border(
                      bottom: BorderSide(
                          width: 1.0, color: AppColors.borderLight))),
              child: Padding(
                          ...
                          SizedBox(
                              ...
                              child: TextButton(
                                ...
                                child: SvgPicture.asset(
                                    'assets/svg/thumbs_up.svg',
                                    width: 18,
                                    height: 18),
                                onPressed: () =>
                                    debugPrint('thumbs up pressed'),
                              )),
                          ...
                          SizedBox(
                              ...
                              child: TextButton(
                                  ...
                                  child: SvgPicture.asset(
                                      ...
                                      height: 18),
                                  onPressed: () =>
                                      debugPrint('thumbs down pressed')))
                        ],
                      )
                    ],
                  )),
